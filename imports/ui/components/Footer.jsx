    ...
    render() {
        return (
            <div>
                ...
                <span className="text-muted"><a href="https://raw.githubusercontent.com/doublep-Philip/coowscan/rizon/LICENSE" target="_blank"><T>navbar.license</T></a> &copy;{moment().format('YYYY')}. </span>
